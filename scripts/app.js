    ...
    <div class="site-header">
      ...
      <aside id="siteNav" class="nav__panel" data-nav-panel hidden>
        ...
        <nav class="nav nav--mobile" aria-label="Mobile menu">
          <ul class="menu-list" role="menu" style="list-style:none;margin:0;padding:0">
            <li role="none"><a role="menuitem" class="menu-item nav__link" href="${href('/index.html')}">Home</a></li>
            ${auth.isAuthed ? `
              <li role="none"><a role="menuitem" class="menu-item nav__link" href="${dashboardFor(user)}">Dashboard</a></li>
              <li role="none"><a role="menuitem" class="menu-item nav__link" href="${profileHref(user)}">Profile</a></li>
              <li role="none"><a role="menuitem" class="menu-item nav__link" href="${href('/pages/opportunities.html')}">Opportunities</a></li>
              <li role="none"><a role="menuitem" class="menu-item nav__link" href="${href('/pages/help/index.html')}">Help Center</a></li>
              <li role="none"><button role="menuitem" class="menu-item nav__link is-action" data-action="logout" type="button">Logout</button></li>
            ` : `
              <li role="none"><a role="menuitem" class="menu-item nav__link" href="${href('/pages/login.html')}">Log in</a></li>
              <li role="none"><a role="menuitem" class="menu-item nav__link btn--primary" href="${href('/pages/signup.html')}">Sign up</a></li>
              <li role="none"><a role="menuitem" class="menu-item nav__link" href="${href('/pages/help/index.html')}">Help Center</a></li>
            `}
          </ul>
        </nav>
