...
// Fix footer links for pages files
function fixPagesFooterLinks(content) {
  // Replace the incorrect paths with correct relative paths
  let newContent = content.replace(
    /<a href="\/help">Help Center<\/a>/g,
    '<a href="../help">Help Center</a>'
  );
  
  newContent = newContent.replace(
    /<a href="\/help\?topic=faq">FAQ<\/a>/g,
    '<a href="../help?topic=faq">FAQ</a>'
  );
...
console.log(`\nFixed ${updatedCount} pages files with correct Help Center paths!`);
